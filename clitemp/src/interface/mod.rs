...
use crate::bundler::bundle::{PackageType, Settings, SettingsBuilder};
...
pub trait AppSettings {
    fn get_package_settings(&self) -> crate::bundler::bundle::PackageSettings;
    fn get_bundle_settings(
        &self,
        config: &Config,
        features: &[String],
    ) -> crate::Result<crate::bundler::bundle::BundleSettings>;
    fn app_binary_path(&self, options: &Options) -> crate::Result<PathBuf>;
    fn get_binaries(
        &self,
        config: &Config,
        target: &str,
    ) -> crate::Result<Vec<crate::bundler::bundle::BundleBinary>>;
