...
use crate::bundler::bundle::{common, Settings};
...
pub fn list_icon_files(
    settings: &Settings,
    data_dir: &Path,
) -> crate::bundler::Result<BTreeMap<Icon, PathBuf>> {
...
pub fn copy_icon_files(settings: &Settings, data_dir: &Path) -> crate::bundler::Result<Vec<Icon>> {
...
pub fn generate_desktop_file(
    ...
    data_dir: &Path,
) -> crate::bundler::Result<(PathBuf, PathBuf)> {
