...
(async function () {
     ...
     * @type {CryptoKey}
     */
    const aesGcmKey = await window.crypto.subtle.importKey('raw', aesGcmKeyRaw, 'AES-GCM', false, [
        'encrypt',
    ]);
    ...
    async function encrypt(data) {
        ...
        return window.crypto.subtle.encrypt(algorithm, aesGcmKey, encoded).then((payload) => {
